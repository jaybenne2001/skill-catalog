...
function ResultsContent() {
  ...
  const gaps = searchParams.get('gaps')?.split(',').filter(Boolean) || []
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Card className="p-8 text-center bg-red-50 border-red-200">
            <div className="text-6xl font-bold text-red-600 mb-3">{keyword}%</div>
          ...
          <Card className="p-8 text-center bg-green-50 border-green-200">
            <div className="text-6xl font-bold text-green-600 mb-3">{capability}%</div>
        ...
        {parseInt(delta) > 20 && (
          <Card className="p-8 mb-12 bg-green-50 border-green-200">
            ...
            <p className="text-gray-700">
              While traditional keyword matching shows {keyword}%, your actual capability coverage is {capability}%. 
              You have <strong>{delta} percentage points of hidden value</strong> that most ATS systems would miss. 
              Your transferable skills make you more qualified than the keyword match suggests.
            </p>
          </Card>
        )}
        ...
        <div className="space-y-12">
          <Card className="p-8">
            <h2 className="text-2xl font-bold mb-6">Skill Consolidation Flow (Sankey Diagram)</h2>
            <p className="text-gray-600 mb-6">
              This chart shows how your technologies map through root capabilities to job requirements.
            </p>
            <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-lg p-12 aspect-video flex items-center justify-center border-2 border-dashed border-gray-300">
              <div className="text-center max-w-xl">
                ...
                <p className="text-xl font-bold text-gray-700 mb-4">Sankey Visualization</p>
          ...
          <Card className="p-8">
            <h2 className="text-2xl font-bold mb-6">Capability Coverage (Radar Chart)</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg p-12 aspect-square max-w-2xl mx-auto flex items-center justify-center border-2 border-dashed border-gray-300">
              <div className="text-center">
                <div className="text-6xl mb-6">🎯</div>
                <p className="text-xl font-bold text-gray-700 mb-4">Radar Chart Analysis</p>
                <p className="text-gray-600 mb-4">
                  {capability}% Average Coverage
                </p>
                <p className="text-sm text-gray-500">
            ...
            <Card className="p-8 bg-orange-50 border-orange-200">
              ...
              <div className="bg-white rounded-lg p-6">
                ...
                <p className="text-sm text-gray-600">
                  Focus on your transferable capabilities. For example: "While I haven't used [missing tech] specifically, 
                  I have extensive experience with similar tools that provide the same capabilities..."
                </p>
              </div>
            </Card>
          )}
